...
*/
    ...
    */
    ...
    if (options.Command.CommandType == NCommandType::kInfo) {
        ...
        __android_log_print(ANDROID_LOG_VERBOSE, APPNAME, "Main.CPP %s",
                            ArchivePathsFullSorted.Front().Ptr());
//        __android_log_print(ANDROID_LOG_VERBOSE, APPNAME, "Main.CPP %d", ArchivePathsFullSorted.);
        __android_log_print(ANDROID_LOG_VERBOSE, APPNAME, "Main.CPP %s",
                            ArchivePathsFullSorted.Front().Ptr());
        if (hresultMain == S_OK)
            if (isExtractGroupCommand) {
...
//
//                        __android_log_print(ANDROID_LOG_VERBOSE, APPNAME, "Size");
//                        __android_log_print(ANDROID_LOG_VERBOSE, APPNAME, "Compressed ");
//                        __android_log_print(ANDROID_LOG_VERBOSE, APPNAME, "Size " + stat.UnpackSize);
//                        __android_log_print(ANDROID_LOG_VERBOSE, APPNAME, "Compressed " + stat.PackSize);
                        if (hashCalc) {
                            *so << endl;
                            PrintHashStat(*so, hb);
                        }
                ...
                UString paths = MakePathFromParts(ArchivePathsSorted);

//                for (int i = 0; i < paths.Len(); i++) {
//                    __android_log_print(ANDROID_LOG_VERBOSE, APPNAME, "MakePathFromParts %s", paths.Ptr(i));
//
//                }
